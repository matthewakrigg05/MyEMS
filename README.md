...
and then staff accounts so that the staff can log their hours themself but I am yet to decide. I look forward to putting more on here and completing items on the checklist below of features. 

- [ ] - Add and remove employees + info
- [ ] - Calculate pay each month/biweekly/weekly
- [ ] - Generate Pay-Slips
- [ ] - Ability to log hours each day
- [ ] - Generate Rotas
